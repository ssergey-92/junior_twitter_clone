"""Module for testing endpoint 'follow other user' from app.fastapi_app.py ."""
...
follow_user_url = APPLICATION_ENDPOINTS["follow_user"]["endpoint"]
follow_user_method = APPLICATION_ENDPOINTS["follow_user"]["http_method"]
